...
//import static com.sirdanieliii.SD_SMP.configuration.ConfigManager.generalMsgs;
...
//
//public class coordsClearBACKUP2 extends SubCommand {
//    @Override
...
//        return generalMsgs.get("coords_clear");
//    }
//
//    @Override
...
//            player.sendMessage(translateMsgClr(cmdHeader("coords") + "&FAre you sure you want clear ALL your coords?"));
//            player.spigot().sendMessage(confirmMsg);
//        } else {
//            conf.getConfig().set("coordinates", new Array[]{});
//            player.sendMessage(translateMsgClr(cmdHeader("coords") + "&FAll coords &Cremoved &Asuccessfully!"));
//            return true;
//        }
//        return false;
//    }
