...
public class CommandManager implements TabExecutor {
    static Map<String, List<SubCommand>> cmdCategories = new HashMap<>();
    ...
    public static void displayAllCommands(Player player) { // Maybe add pages to this one day
        ...
        for (List<SubCommand> i : cmdCategories.values()) for (SubCommand subCommand : i) player.sendMessage(subCommand.getSyntax() + " §7→ " + subCommand.getDescription());
        // Single Commands
